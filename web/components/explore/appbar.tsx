...
// import {  formatAddress, updateMainWallet } from '../../lib/transactionutils'; // Adjust the import path as needed

// export default function AppBar() {
//   const [walletAddress, setWalletAddress] = useState(getMainWallet()); // Initialize with the main wallet address
//   const [inputValue, setInputValue] = useState('');

//   // Handle search button click to update the wallet address
//   const handleSearch = () => {
//     if (inputValue.trim()) {
//       setWalletAddress(inputValue.trim());
//       setInputValue('');
//       // You would typically dispatch this value to your state management system or parent component
//       console.log("New wallet address set:", inputValue.trim());
//     }
//   };
